...
# Script to register PostgreSQL Debezium connector with Kafka Connect

CONNECTOR_NAME="postgres-connector"
CONNECTOR_CONFIG_FILE="postgres-connector-config.json"
...
echo ""
echo "Done! Check Kafka topics for: postgresql_server.public.books"
